...
export function HeroSection() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
      <div className="lg:col-span-7 bg-card border border-border rounded-xl p-8 flex flex-col justify-center space-y-6 transition-colors duration-300 hover:border-amber-500/30">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button className="border border-border hover:bg-accent text-foreground font-bold px-8 py-3 rounded-xl transition-colors">
            Tìm hiểu thêm
          </button>
        </div>
      </div>

      <div className="lg:col-span-5 bg-card border border-border rounded-xl overflow-hidden flex flex-col items-center justify-center min-h-96 relative [contain:strict]">
        <InteractiveCube />
      </div>
    </section>
  )
